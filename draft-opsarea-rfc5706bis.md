...
##  Audience and Intended Use {#sec-audience-intended-use}
   ...
   protocols, documenting key
   considerations, and helping to provide a reasonably
   consistent format for such documentation.This Best Current Practice (BCP) 
   is intended to offer a flexible set of guiding principles applicable to 
   various circumstances. It provides a framework for working groups to ensure
   that manageability considerations are an integral part of the protocol design 
   process, and its use should not be misinterpreted as imposing new hurdles 
  ...
  A core principle of this BCP is to encourage discussion and explicit 
  decision-making rather than mandating any specific solution. It
  does not impose a specific management or operational solution,
   ...
   the decision to incorporate this BCP's advice into their work remains with the protocol designers 
